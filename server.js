...
app.get('/crudTipsBoard', function (request, response) {
    ...
    fs.readFile(__dirname + '/views/crudTipsBoard.html', 'utf8', function (error, data) {
        ...
        connection.query('SELECT * FROM tips '+ condition + ' ORDER BY date desc limit ?, 5', [5 * (page - 1)], function (error, results) {
...
app.post('/insertTips', function (request, response) {
    ...
    connection.query('INSERT INTO tips (title, sort, userName, view, likes, text, img) VALUES (?, ?, ?, 0, 0, ?, NULL)', [
...
app.get('/crudDailyBoard', function (request, response) {
    ...
    fs.readFile(__dirname + '/views/crudDailyBoard.html', 'utf8', function (error, data) {
        if (error) console.log(error);
        connection.query('SELECT * FROM daily ORDER BY date desc limit ?, 5', [5 * (page - 1)], function (error, results) {
